...
class DtoFieldScanTest {
     ...
     *
     * <p>This test guards the scan's configuration — it ensures that if any future DTO
     * accidentally gains one of these field names, the package scan will catch it. Without
     * this test, a developer could remove entries from {@code FORBIDDEN_FIELD_NAMES} and the
     * main scan test would silently pass even though the guard was weakened.</p>
     *

 ...
 * {@code /embed} endpoint in {@link StompCallback} — the raw URL string from a Mastodon event
 * must pass this validator. Implementations are responsible for enforcing an allowlist of safe
 * schemes and blocking resolution of private, link-local, and loopback addresses (SSRF guard).</p>
 *

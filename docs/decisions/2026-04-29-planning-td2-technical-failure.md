...
- [TD-1 JsonProcessingException Logging Fix — Planning](2026-04-28-planning-td1-json-parse-exception.md) (sibling reference)
- [TD-1 JsonProcessingException Logging Fix — Acceptance](2026-04-28-acceptance-td1-json-parse-exception.md)

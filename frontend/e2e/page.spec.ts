...
test('page - footer is visible', async ({ page }) => {
  ...
  await expect(page.getByRole('contentinfo')).toContainText('You don\'t want your toots to be shown here? Block glacier@mastodon.seism0saurus.de in your account.');
